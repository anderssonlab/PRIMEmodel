...
2. **PRIMEmodel focal workflow** [running with **./PRIMEmodel.sh --predictFocal**]
...
2. **Configure Parameters**
   ...
   - `path/to/PRIMEmodel/genomewide_prediction/bash_config_PRIMEmodel_predict.sh`
   - `path/to/PRIMEmodel/genomewide_prediction/bash_config_PRIMEmodel_predictFocal.sh`
...
3. **Run the Scripts**
   ...
   - **Run PRIMEmodel and PRIMEmodel_focal**: 
     ...
     ```bash
     ./PRIMEmodel.sh --config <config_file> --predict
     ./PRIMEmodel.sh --config <config_file> --predictFocal
     
     # example <config_file>
     ./PRIMEmodel.sh --config bash_config_PRIMEmodel_predict.sh --predict
     ./PRIMEmodel.sh --config bash_config_PRIMEmodel_predictFocal.sh --predictFocal
     ```
