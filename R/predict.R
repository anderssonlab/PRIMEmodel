...
#'
#' This function executes the complete PRIMEmodel pipeline
...
#' where a log file named `"PRIMEmodel.log"`
...
#' Use pre-trained PRIME LightGBM models
...
predict <- function(
  ...
  plc_message("\n")
  plc_message("🚀 Starting PRIMEmodel pipeline")

  # _2_
  plc_message("\n")
  plc_message("🚀 Running PRIMEmodel: get extended tc or validate the tc object provided") # nolint: line_length_linter.
  ...
  # _3_
  plc_message("\n")
  plc_message("🚀 Running PRIMEmodel: sliding windows covering reduced TC regions") # nolint: line_length_linter.
  ...
  # _4_
  plc_message("\n")
  plc_message("🚀 Running PRIMEmodel: compute count & normalized profiles for each sample") # nolint: line_length_linter.
  ...
  # _5_
  plc_message("\n")
  plc_message("🚀 Running PRIMEmodel: Prediction using PRIME model")
  ...
  # _6_
  plc_message("\n")
  plc_message("🚀 Running PRIMEmodel: Postprocessing prediction BEDs")
  ...
  plc_message("✅✅✅ PRIMEmodel pipeline completed successfully !!!!!")
